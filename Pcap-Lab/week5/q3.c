...
int main()
{
	...
	cl_mem arrlength = clCreateBuffer(context,CL_MEM_READ_ONLY,sizeof(int),NULL,&ret);

	//Copy the lists A and B to buffer
	ret = clEnqueueWriteBuffer(command_queue,a_mem_obj,CL_TRUE,0,LIST_SIZE * sizeof(int),A,0,NULL,NULL);
	ret = clEnqueueWriteBuffer(command_queue,arrlength,CL_TRUE,0,sizeof(int),&LIST_SIZE,0,NULL,NULL);
	...
	ret = clSetKernelArg(kernel,2,sizeof(cl_mem),(void *)&arrlength);
